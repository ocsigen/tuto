...
Eliom client-server applications are running in your browser for a `certain lifetime` and consist of one or several pages/URLs. An application has its associated js file, which must have the same name ([generated automatically by the default makefile](./how-to-compile-my-ocsigen-pages.md) and added automatically by Eliom in the page).
...
```
More information about parameters: [How to use GET parameters (parameters in the URL)?](./how-to-use-get-parameters-or-parameters-in-the-url.md)

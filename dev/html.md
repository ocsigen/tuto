...
Have a look at [Tyxml's manual](https://ocsigen.org/tyxml/latest/tyxml/index.html) and `Eliom's manual` for more documentation about HTML manipulation in OCaml.
